...
const HomePage = () => {
    return (
        <div className="bg-[url('https://www.tailwindtap.com/assets/components/hero/fintech/backgradeint.png')] bg-cover bg-no-repeat w-full ">
          ...
          <section className="relative pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
              <div className="max-w-2xl mx-auto text-center">
                ...
                Your Gateway to Knowledge and Growth. Discover a world of comprehensive learning resources, expert guidance, and innovative tools designed to empower students and professionals alike on their educational journey.
                </p>
                <a
                  href="#"
                  title=""
